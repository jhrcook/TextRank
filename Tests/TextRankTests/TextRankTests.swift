...
final class TextRankTests: XCTestCase {
    ...
    func testPageRankConvergence() {
        ...
        let knownScores: [String: KnownResults] = [
            "swifts are among the fastest of birds, and larger species like the white-throated needletail have been reported travelling at up to 169 km/h (105 mph) in level flight": KnownResults(index: 0, score: 0.07852985),
            "changing the angle between the bones of the wingtips and forelimbs allows swifts to alter the shape and area of their wings to increase their efficiency and maneuverability at various speeds": KnownResults(index: 1, score: 0.057728272),
            "resemblances between swifts and swallows are due to convergent evolution, reflecting similar life styles based on catching insects in flight": KnownResults(index: 2, score: 0.05587443),
            "swifts as a family have smaller egg clutches and much longer and more variable incubation and fledging times than passerines with similarly sized eggs, resembling tubenoses in these developmental factors": KnownResults(index: 3, score: 0.05310661),
            "swifts range in size from the pygmy swiftlet (collocalia troglodytes), which weighs 5.4 g and measures 9 cm (3.5 in) long, to the purple needletail (hirundapus celebensis), which weighs 184 g (6.5 oz) and measures 25 cm (9.8 in) long": KnownResults(index: 4, score: 0.052287854),
            "the swifts are a family, apodidae, of highly aerial birds": KnownResults(index: 5, score: 0.05228759),
            "the treeswifts are closely related to the true swifts, but form a separate family, the hemiprocnidae": KnownResults(index: 6, score: 0.051925335),
            "young birds reach a maximum weight heavier than their parents; they can cope with not being fed for long periods of time, and delay their feather growth when undernourished": KnownResults(index: 7, score: 0.04921896),
            "swifts and seabirds have generally secure nest sites, but their food sources are unreliable, whereas passerines are vulnerable in the nest but food is usually plentiful": KnownResults(index: 8, score: 0.048845742),
            "swifts occur on all the continents except antarctica, but not in the far north, in large deserts, or on many oceanic islands": KnownResults(index: 9, score: 0.04844537),
            "swifts are placed in the order apodiformes with hummingbirds": KnownResults(index: 10, score: 0.046230577),
            "some species can survive short periods of cold weather by entering torpor, a state similar to hibernation": KnownResults(index: 11, score: 0.04308829),
            "the nest of many species is glued to a vertical surface with saliva, and the genus aerodramus use only that substance, which is the basis for bird's nest soup": KnownResults(index: 12, score: 0.041701823),
            "the tradition of depicting swifts without feet continued into the middle ages, as seen in the heraldic martlet": KnownResults(index: 13, score: 0.04097793),
            "the swifts of temperate regions are strongly migratory and winter in the tropics": KnownResults(index: 14, score: 0.040977925),
            "the swiftlets or cave swiftlets have developed a form of echolocation for navigating through dark cave systems where they roost.one species, the three-toed swiftlet, has recently been found to use this navigation at night outside its cave roost too": KnownResults(index: 15, score: 0.033389345),
            "many have a characteristic shape, with a short forked tail and very long swept-back wings that resemble a crescent or a boomerang": KnownResults(index: 16, score: 0.031601563),
            "the flight of some species is characterised by a distinctive 'flicking' action quite different from swallows": KnownResults(index: 17, score: 0.03015823),
            "they are superficially similar to swallows, but are not closely related to any passerine species": KnownResults(index: 18, score: 0.029574359),
            "the wingtip bones of swiftlets are of proportionately greater length than those of most other birds": KnownResults(index: 19, score: 0.026257094),
            "the family name, apodidae, is derived from the greek ἄπους (ápous), meaning 'footless', a reference to the small, weak legs of these most aerial of birds": KnownResults(index: 20, score: 0.025869984),
            "the eggs hatch after 19 to 23 days, and the young leave the nest after a further six to eight weeks": KnownResults(index: 21, score: 0.025081683),
            "they share with their relatives the hummingbirds a unique ability to rotate their wings from the base, allowing the wing to remain rigid and fully extended and derive power on both the upstroke and downstroke": KnownResults(index: 22, score: 0.025023814),
            "in a single year the common swift can cover at least 200,000 km. and in a lifetime, about two million kilometers; enough to fly to the moon five times over": KnownResults(index: 23, score: 0.024281766),
            "this flight arrangement might benefit the bird's control and maneuverability in the air": KnownResults(index: 24, score: 0.022396337),
            "even the common swift can cruise at a maximum speed of 31 metres per second": KnownResults(index: 25, score: 0.017080668),
            "both parents assist in raising the young": KnownResults(index: 26, score: 0.01351087),
            "the downstroke produces both lift and thrust, while the upstroke produces a negative thrust (drag) that is 60% of the thrust generated during the downstrokes, but simultaneously it contributes lift that is also 60% of what is produced during the downstroke": KnownResults(index: 27, score: 0.010717979),
        ]
